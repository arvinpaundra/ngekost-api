...
func (_m *UserRepository) FindById(ctx context.Context, userId string) (*entity.User, error) {
...
// Update provides a mock function with given fields: ctx, tx, user, userId
func (_m *UserRepository) Update(ctx context.Context, tx *gorm.DB, user *entity.User, userId string) error {
	ret := _m.Called(ctx, tx, user, userId)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *gorm.DB, *entity.User, string) error); ok {
		r0 = rf(ctx, tx, user, userId)
	} else {
		r0 = ret.Error(0)
	}
